...
import com.shensou.newpress.fragment.HomeTopTabFragment;

import java.util.ArrayList;
import java.util.List;

public class HomeTopTabPagerAdapter extends FragmentStatePagerAdapter {

	private List<HomeTopTabFragment> fragments = new ArrayList<>();
	private List<YuyueSpecialPersonGson.ResponseBean.ActiveTypeBean> userChannelLists;
	private final FragmentManager fm;

	public HomeTopTabPagerAdapter(FragmentManager fm) {
		super(fm);
		// TODO Auto-generated constructor stub
		this.fm = fm;
	}

	public HomeTopTabPagerAdapter(FragmentManager fm, List<HomeTopTabFragment> fragments, List<YuyueSpecialPersonGson.ResponseBean.ActiveTypeBean> userChannelLists) {
		super(fm);
		// TODO Auto-generated constructor stub
		this.fm = fm;
	...
	public void appendList(ArrayList<HomeTopTabFragment> fragment) {
		fragments.clear();
...
//	}
	...
	public void setFragments(ArrayList<HomeTopTabFragment> fragments) {
