 ...
 */
public class MyOrderAdapter extends BaseLoadingAdapter<MyOrderGson.ResponseBean> {
    ...
    public MyOrderAdapter(List<MyOrderGson.ResponseBean> list, Context context) {
