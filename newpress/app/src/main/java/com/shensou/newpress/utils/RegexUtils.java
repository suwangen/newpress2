...
public final class RegexUtils {
    ...
    /**
     * @Description: TODO(校验密码6-18位数字或字母)
     * @param @param pwd 密码
    ...
    /**
     * @Description: TODO(校验确认密码)
     * @param @param pwd 密码
     *     @return 消息信息
     */
    public static String checkPassWord(String pwd,String confirmPwd){
    	String msg="";
    	String regex = "^([0-9a-zA-Z_]){6,18}";
    	if(pwd.length()==0){
    		msg="请输入密码";
            ...
            msg="请确认密码";
        }else if(!Pattern.matches(regex, pwd)||!Pattern.matches(regex, confirmPwd)){
    		msg="请输入6-18位数字或字母";
     ...
     * @return void    返回类型
     */
    public static boolean MobileIsRight(String mobile){
        //校验手机号码
    ...
    private boolean checkPwd(String pwd){
        //校验手机号码
        String msg = RegexUtils.checkPassWord(pwd, pwd);
        if(!msg.equals("")){
            ToastUtil.showMyLongToast(msg);
            return false;
        }else
