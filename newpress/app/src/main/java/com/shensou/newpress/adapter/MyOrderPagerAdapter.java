...
public class MyOrderPagerAdapter extends FragmentStatePagerAdapter {
	...
	public MyOrderPagerAdapter(FragmentManager fm, List<MyOrderFragment> fragments, List<YuyueSpecialPersonGson.ResponseBean.ActiveTypeBean> userChannelLists) {
		super(fm);
		// TODO Auto-generated constructor stub
		this.fm = fm;
	...
	public void appendList(ArrayList<MyOrderFragment> fragment) {
		fragments.clear();
...
//	}
	...
	public void setFragments(ArrayList<MyOrderFragment> fragments) {
