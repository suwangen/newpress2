...
import com.shensou.newpress.BuildConfig;
...
public class ImageLoadProxy {
    ...
    public static Bitmap loadImageSync(String url,int loadingResource) {
        ImageSize imageSize = new ImageSize(275, 290, 0);
         return imageLoader.loadImageSync(url,imageSize,getOptions4PictureList(loadingResource));
    }
    /**
