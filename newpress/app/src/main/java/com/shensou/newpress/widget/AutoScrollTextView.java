...
public class AutoScrollTextView extends TextView {  
         ...
         *            显示的内容  
         */  
        public void initScrollTextView(WindowManager windowManager, String text,float textlenth) {  
            // 得到画笔,获取父类的textPaint  
            paint = this.getPaint();  
            // 得到文字  
            this.text = text;  
            textLength = textlenth;// 获得当前文本字符串长度  
        ...
        protected void onDraw(Canvas canvas) {  
            if (isStarting) {  
                // A-Alpha透明度/R-Red红色/g-Green绿色/b-Blue蓝色  
