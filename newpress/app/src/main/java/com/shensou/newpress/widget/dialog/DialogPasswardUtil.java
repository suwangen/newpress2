...
//		dialog_default_address_prompt.setText(context.getResources().getString(R.string.set_pay_pwd));
		...
		dialog_default_address_prompt.setText("支付密码");
	...
	public void setConfirmColor(int res){
		dialog_default_address_confirm.setTextColor(mContext.getResources().getColor(res));
	}
